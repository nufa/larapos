...
class ProductController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		try {
			...
			->with(['success' => $product->name . ' Berhasil di Tambahkan']);
		} catch (\Exception $e) {
	...
	private function saveFile($name, $photo)
	{
		...
		//mengembalikan nama file yang ditampung di variable $images
		return $images;
	}
	...
	public function destroy($id)
	{
		...
		$products->delete();
		return redirect()->route('produk.index')->with(['success' => $products->name .' Telah Dihapus!']);
	}
	...
	public function update(Request $request, $id)
	{
		...
		try{
			...
			return redirect(route('produk.index'))
			->with(['success' => $product->name .' Diperbaharui']);
		} catch (\Exception $e) {
